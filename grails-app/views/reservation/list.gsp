			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="codeReservation" title="${message(code: 'reservation.codeReservation.label', default: 'Code Reservation')}" />
				...
				<g:each in="${reservationInstanceList}" status="i" var="reservationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${reservationInstance.id}">${fieldValue(bean: reservationInstance, field: "codeReservation")}</g:link></td>
